  ...
  $defs: {
    ...
    song: {
      ...
      properties: {
        ...
        lyricTracks: { type: "array", items: { $ref: "#/$defs/lyricTrack" } },
        metadata: { $ref: "#/$defs/safeJson" },
      },
      additionalProperties: false,
    },
    lyricTrack: {
      ...
      properties: {
        ...
        events: { type: "array", items: { $ref: "#/$defs/lyricEvent" } },
      },
      additionalProperties: false,
    },
    lyricEvent: {
      ...
      properties: {
        ...
        start: { $ref: "#/$defs/timePosition" },
        duration: { $ref: "#/$defs/duration" },
        anchorEventRef: { $ref: "#/$defs/stableId" },
    ...
    section: {
      ...
      properties: {
        ...
        lyricTrackRefs: { type: "array", items: { $ref: "#/$defs/stableId" } },
      },
      additionalProperties: false,
    },
    idea: {
