...
export const capabilityProfileSchema = {
  ...
  oneOf: [
    ...
    },
    {
      ...
      properties: {
        formatVersion: { const: "0.1.0" },
        profileType: { const: "learning-plan" },
        planId: { type: "string" },
        planHash: { type: "string", pattern: "^sha256:[a-f0-9]{64}$" },
        arrangementId: { type: "string" },
    ...
    },
    {
      ...
      properties: {
        ...
        implementationHash: { type: "string", pattern: "^sha256:[a-f0-9]{64}$" },
        capabilities: { type: "array", items: { $ref: "#/$defs/capabilityEvidence" } },
      },
      additionalProperties: false,
    },
    {
      ...
      properties: {
        formatVersion: { const: "0.1.0" },
        profileType: { const: "environment" },
        environmentId: { type: "string", minLength: 1 },
        environmentHash: { type: "string", pattern: "^sha256:[a-f0-9]{64}$" },
        capabilities: { type: "array", items: { $ref: "#/$defs/capabilityEvidence" } },
      },
      additionalProperties: false,
    },
